...
-- DropForeignKey
ALTER TABLE "PrintJob" DROP CONSTRAINT "PrintJob_restaurantId_fkey";

-- DropForeignKey
ALTER TABLE "RestaurantUser" DROP CONSTRAINT "RestaurantUser_restaurantId_fkey";

-- DropIndex
DROP INDEX "DeliveryJob_shop_restaurantId_idx";

-- DropTable
DROP TABLE "LoginToken";

-- DropTable
DROP TABLE "PortalOrderStatus";
